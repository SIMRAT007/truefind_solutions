...
const AboutUs = () => {
  ...
  return (
    <section className="bg-white text-black py-16 md:px-20" id="about">
      {/* Tag */}
  <div className="inline-flex items-center bg-[#e6f0fa] text-[#2E81CC] text-sm font-semibold px-4 py-1 rounded-full mb-6">
      ...
      <div className="flex flex-col lg:flex-row items-start lg:items-center gap-10">
        ...
        {/* Description */}
  <div className="w-full lg:w-1/2 text-black text-lg md:border-l-4 border-[#2E81CC] pl-6 max-md:text-center max-md:pl-0">
          <p>
      ...
      {isDialogOpen && (
        <div className="fixed inset-0 bg-black/30 backdrop-blur-md flex items-center justify-center z-50 p-4">
          ...
          >
            ...
            <h2 className="text-3xl font-bold mb-3 text-black">Welcome to TrueFind Solutions</h2>
            ...
            <div className="space-y-6 text-black">
              ...
              <h3 className="text-xl font-bold text-black mt-8 mb-2">Our Approach</h3>
              <p>
              ...
              <h3 className="text-xl font-bold text-black mt-8 mb-2">Consultative Approach</h3>
              <p>
              ...
              <h3 className="text-xl font-bold text-black mt-8 mb-2">Unlocking The Value In Your Technology Investment</h3>
              <p>
              ...
              <h3 className="text-xl font-bold text-black mt-8 mb-2">Accreditations</h3>
              <p>
