...
const Navbar = () => {
  ...
  return (
    <nav className="text-black max-md:text-black z-100 absolute w-full top-0 left-0 right-0">
      <div className="md:backdrop-filter md:bg-white p-1 md:shadow-lg z-50 md:w-[95%] md:mx-auto md:mt-10 md:rounded-2xl mx-auto top-0 left-0 right-0 max-md:bg-white max-md:px-4">
