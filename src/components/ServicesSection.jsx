...
export default function ServicesSection() {
	...
	return (
		<div ref={servicesRef} className="text-white px-6 py-5 container mx-auto">
			{/* Top Section */}
			<div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-16">
				<div>
					<div className="inline-flex items-center gap-2 px-4 py-2 border border-gray-500 text-sm rounded-full text-gray-300 mb-6">
			...
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
				{services.map((service, index) => (
					<div
						key={index}
						className="bg-gradient-to-b from-[#252530] to-[#1a1a1f] rounded-3xl p-8 text-center hover:shadow-2xl hover:shadow-[#2E81CC]/10 transition-all duration-300 transform hover:-translate-y-2 h-full flex flex-col justify-between"
					>
						<div className="bg-black/30 rounded-2xl p-6 mb-6 mx-auto w-48 h-48 flex items-center justify-center">
							<img
								src={service.icon}
								alt={service.title}
			...
			{activeService && (
				<div className="fixed inset-0 bg-black/80 backdrop-blur-md flex items-center justify-center z-50 p-4 animate-fadeIn">
					<div 
						className="bg-gradient-to-b from-[#252530] to-[#1a1a1f] rounded-3xl p-10 max-w-3xl w-full relative text-left shadow-2xl max-h-[90vh] overflow-y-auto animate-scaleIn"
					...
					>
						...
						<div className="flex items-center gap-6 mb-6">
							<div className="bg-black/30 rounded-2xl p-4 w-20 h-20 flex items-center justify-center flex-shrink-0">
								<img
			...
			{viewAllOpen && (
				<div className="fixed inset-0 bg-black/80 backdrop-blur-md flex items-center justify-center z-50 p-4">
					<div className="bg-gradient-to-b from-[#252530] to-[#1a1a1f] rounded-3xl p-8 max-w-5xl w-full relative shadow-2xl max-h-[90vh] overflow-y-auto">
						<button
							className="absolute top-6 right-6 text-white text-xl bg-white/10 w-10 h-10 rounded-full flex items-center justify-center hover:bg-white/20 transition-colors cursor-pointer"
						...
						<div className="text-gray-300 space-y-8">
							{/* IT Audits */}
							<div>
								<h3 className="text-2xl font-bold text-white mb-3">IT Audits</h3>
							...
							{/* Hardware Supply */}
							<div>
								<h3 className="text-2xl font-bold text-white mb-3">Hardware Supply</h3>
							...
							{/* Office Move Service */}
							<div>
								<h3 className="text-2xl font-bold text-white mb-3">Office Move Service</h3>
